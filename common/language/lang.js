export default {
	'zh-CN':{
		common:{
			...
			gene:'基因',temperament:'气质',constellation:'星座',brief:'个人简介',
			years:'岁',age:'年龄',height:'身高',weight:'体重',faceShape:'脸型',characteristics:'个性特点',tshirtSize:'T恤衫尺寸',shirtSize:'衬衫尺寸',
			clothSize:'衣服尺寸',trousersSize:'裤子尺寸',shoeSize:'鞋子尺寸',yards:'码',selfDesc:'自述',date:'时间',address:'地点',festival:'节日',type:'类型',
			room:'居室',weather:'天气',beginTime:'起始年月',endTime:'结束年月',content:'内容',marryTime:'婚礼时间',newName:'新郎名字',brideName:'新娘名字',
			buyDate:'购买年月',sellDate:'出售年月',heading:'名称',planName:'计划名称',loveFriend:'恋爱对象',course:'历程',carName:'车辆名称',marry:'婚礼',
			desc:'描述',training:'家训',family:'家族',moduleSel:'模块选择',timeSel:'时间选择',baseInfo:'基本信息',personInfo:'个人简介',rank:'同辈排行',
			inheritMan:'传承人',inheritPhone:'传承电话',inheritEmail:'传承邮件',inheritContent:'传承内容',trainContent:'家训内容',
			funcShow:'以下功能最多展示在首页（9个）',langSel:'语言选择',payment:'支付年费',about:'关于我们',privacy:'隐私政策',present:'当前版本',
			clearCache:'清除缓存',reminder:'温馨提示'
		},
		other:{
			and:'与',marriage:'的婚礼',buy:'购买于',sell:'已出售'
		},
		title:{
			all:'全部',personalInfo:'个人信息',appearance:'体貌特征',
		},
		defaultText:{
		...
		selData:{
			...
			"sex":[{"key":-1,"value":"请选择"},{"key":1,"value":"男"},{"key":2,"value":"女"}],
			"bloodType":[{"key":-1,"value":"请选择"},{"key":0,"value":"A型"},{"key":1,"value":"B型"},{"key":2,"value":"AB型"},{"key":3,"value":"O型"}],
			"zodiac":[
				{"key":-1,"value":"请选择"},
			...
			"corporeity":[
				{"key":-1,"value":"请选择"},{"key":0,"value":"平和质"},{"key":1,"value":"气虚质"},{"key":2,"value":"阳虚质"},{"key":3,"value":"阴虚质"},
				{"key":4,"value":"痰湿质"},{"key":5,"value":"湿热质"},{"key":6,"value":"血瘀质"},{"key":7,"value":"气郁质"},{"key":8,"value":"特禀质"}
			],
			"constellation":[
				{"key":-1,"value":"请选择"},
			...
			"size":[
				{"key":-1,"value":"请选择"},
				{"key":0,"value":"XXXS"},{"key":1,"value":"XXS"},{"key":2,"value":"XS"},{"key":3,"value":"S"},
				{"key":4,"value":"M"},{"key":5,"value":"L"},{"key":6,"value":"XL"},{"key":7,"value":"XXL"}
			],
			"faceShape":[
				{"key":-1,"value":"请选择"},
	...
	'en-US':{
		...
		other:{
			and:'and',marriage:'Of Marriage',buy:'Buying ',sell:'Selled '
		},
		title:{
			all:'All',personalInfo:'Personal Info',appearance:'Physical Features'
		},
		defaultText:{
		...
		selData:{
			...
			"sex":[{"key":-1,"value":"Please Select"},{"key":1,"value":"Male"},{"key":2,"value":"Female"}],
			"bloodType":[{"key":-1,"value":"Please Select"},
				{"key":0,"value":"A Type"},{"key":1,"value":"B Type"},
			...
			"corporeity":[
				...
				{"key":4,"value":"Phlegm Dampness"},{"key":5,"value":"Damp Deat"},{"key":6,"value":"Blood Stasis"},{"key":7,"value":"Qi Stagnation"},{"key":8,"value":"Intrinsic Quality"}
			],
			"constellation":[
				{"key":-1,"value":"Please Select"},
