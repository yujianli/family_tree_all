...
<style>
	...
	.tab_line{
		width:70px;height: 1px;background-color: #4DC578;
		margin: 0 auto;
		margin-top: 14px;
	}
	.tab_line_active{
	...
	.pic_opt{
		width: 20px;height: 20px;position: absolute;top: 4px;right: 3%;
	}
	.explain{
		margin-top: 30px;margin-bottom: 34px;font-size: 13px;color: #999;text-align: center;
	}
